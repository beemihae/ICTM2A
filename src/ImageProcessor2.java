...
public class ImageProcessor2 {
	...
	*/
	...
	public  void applyFilters(double width, double height) {
		...
		// Mat imgDst = new Mat(image.size());     
		//Mat imgDst = Highgui.imread(path);          // code compatibel met openCV dat in lejos zit
		Mat imgDst = originalPicture.clone();      // code enkel compatibel met nieuwere versie dan openCV in lejos
		...
		Imgcodecs.imwrite(pathFilteredGray, filteredGray);      //enkel compatibel met nieuwere versie van openCV dan in lejos
