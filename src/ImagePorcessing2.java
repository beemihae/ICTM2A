...
public class ImageProcessor2 {
	public String pathOriginal = "/Users/beemihae/Desktop/ICTM/groundfloor.jpg";
	...
	private int[] robotLocation; // float[angle, x, y]
	...
	public int[] GetRobotLocation() {
		...
		Core.inRange(imgHSV_green, new Scalar(100, 0, 0), new Scalar(150, 10, 10), imgHSV_green);
		...
		int angle = (int) (hoek / Math.PI * 180);
		...
		Imgcodecs.imwrite(pathOriginal, image);
		return RobotLocation;

	}
	public static List<Point[]> DetectObjects(String path, int[] RobotLocation) {
